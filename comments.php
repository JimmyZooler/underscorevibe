...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One comment:', '%1$s comments:', get_comments_number(), 'comments title', 'underscorevibe' ) ),
	...
	?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'underscorevibe' ); ?></p>
	<?php endif; ?>
